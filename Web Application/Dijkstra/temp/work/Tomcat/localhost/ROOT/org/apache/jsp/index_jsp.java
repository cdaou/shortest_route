 ...
 * Generated at: 2020-06-25 19:58:38 UTC
...
return;
    ...
    try {
      ...
      out.write("\t}\r\n");
      out.write("\t#field2 {\r\n");
      out.write("\t    width: calc(100% - 283px);\r\n");
...
for(int i=0;i<tempList.get(j).size();i++){
      ...
      out.write("     \t}\r\n");
      out.write("\t     \tdocument.getElementById('time').innerHTML = \"The time to calculate the shortest path in mili seconds: \" + (Math.round(timeElapsed * 100) / 100).toFixed(3);\r\n");
      out.write("   \t</script>\r\n");
      out.write("  </body>\r\n");
      out.write("</html>");
